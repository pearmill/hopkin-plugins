...
Hopkin connects your Meta, Google, LinkedIn, Reddit, TikTok, ChatGPT Ads, Mailchimp, Google Search Console, and Google Analytics accounts directly to Claude — so you can ask questions, pull reports, and surface insights without touching a dashboard.
...
- **Cross-platform in one conversation** — pull Meta, Google, LinkedIn, Reddit, TikTok, ChatGPT Ads, and Mailchimp data side by side
...
| ChatGPT Ads (OpenAI Ads) | hopkin-chatgpt-ads |
| Mailchimp | hopkin-mailchimp |
| Google Search Console | hopkin-google-search-console |
| Google Analytics (GA4) | hopkin-google-analytics |
